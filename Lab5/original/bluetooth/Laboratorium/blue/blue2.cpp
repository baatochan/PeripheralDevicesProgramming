...
void bt_connect (BLUETOOTH_DEVICE_INFO dev_info)
{
	...
	if (0 == ::WSAStartup(wVersionRequested, &m_data))
	{
		...
		else
		{
			...
			//obex_send_file (s, "a.txt"); system("pause");
      obex_send_file (s, "lena.bmp"); system("pause");
		}
	}
}
...
int main()
{
  ...
  ////FILE * plik ;
  ////plik= fopen ("C:\Users\lab\Documents\Visual Studio 2008\Projects\bt2\bt2\aa.txt","r");
  //fstream plik;
  //plik.open("C:\Users\lab\Documents\Visual Studio 2008\Projects\bt2\bt2\aa.txt", fstream::in | fstream::out | fstream::app);
  //      

  //if (plik.is_open()){cout<<"ddd"; plik.close(); //fclose(plik);
  // }
  //system("pause");
